...
// прежняя версия с дублем кнопок
// import {
//   Component,
//   Input,
//   OnDestroy,
...
//   ////////// 
//   // left slider (2del)
//   // moveSlides(direction: Direction): void {
//   //   const totalSlides = this.slides.length;
//   //   const currentIndex = this.activeSlides.current;
  
//   //   let nextIndex = currentIndex + (direction === Direction.Next ? 1 : -1);
...
//   //     current: nextIndex,
//   //     next: nextIndex === totalSlides - 1 ? 0 : nextIndex + 1
//   //   };
